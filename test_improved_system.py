#!/usr/bin/env python3
"""
Test the improved heart disease prediction system
"""
...
def test_system():
    ...
    if pipeline_exists(pipeline_path):
        ...
        print("🏗️  Building new model pipeline...")
    ...
    encoded_feature_names = [f"feature_{i}" for i in range(preprocessor.transform(X_train).shape[1])]
    shap_df, shap_values = compute_shap_explanation(ensemble_model, preprocessor.transform(X_train), encoded_feature_names)
